...
def connect_to_website(url):
    try:
        ...
        if soup.find('div', class_='ds-text-tight-s ds-font-regular ds-px-4 ds-py-2 ds-border-y ds-border-line ds-text-typo-mid1'):
            match_partnership = soup.find('div',class_='ds-text-tight-s ds-font-regular ds-px-4 ds-py-2 ds-border-y ds-border-line ds-text-typo-mid1')
...
# while True:
#     hostname = "www.espncricinfo.com"
#     urls = ["/series/one-day-cup-2023-1347398/gloucestershire-vs-lancashire-1st-quarter-final-1347563/live-cricket-score",
#             ]
